/* ===========================================================
   ...
   Selected results navigate to category.html.
   =========================================================== */
(function () {
  var DATA = [
  ...
  function render(q) {
    ...
    Array.prototype.forEach.call(panel.querySelectorAll('.sr-item'), function (el) {
      el.addEventListener('mousedown', function (e) { e.preventDefault(); location.href = 'category.html'; });
    });
  }
  ...
  input.addEventListener('keydown', function (e) {
    ...
    else if (e.key === 'Enter' && active >= 0) { e.preventDefault(); location.href = 'category.html'; }
